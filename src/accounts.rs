...
mod client {
    ...
    pub type AccountDataReference = std::sync::Arc<async_std::sync::RwLock<AccountData>>;
    ...
    impl AccountData {
        ...
        pub fn from_account_info<'info>(
            ...
            let space = src.len();
            let buffer_len = match disposition {
    ...
    pub struct AccountDataInstance {
        pub key: Pubkey,
        account_data: AccountData,
    }

    impl AccountDataInstance {
        pub fn new(space: usize) -> AccountDataInstance {

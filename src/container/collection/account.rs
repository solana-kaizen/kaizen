...
pub type PdaCollection<'info, 'refs> =
    PdaCollectionInterface<'info, PdaCollectionSegmentInterface<'info, 'refs>>;
    ...
    M: CollectionMeta,
{
    ...
    pub fn try_load_container<'refs, T>(
        &self,
        ...
        T: Container<'info, 'refs>,
    {
        ...
        if T::container_type() != container::try_get_container_type(account)? {
            return Err(error_code!(
                ErrorCode::AccountCollectionInvalidContainerType
            ));
        }
